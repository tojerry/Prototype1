Shader "VacuumShaders/Mesh Materializer/Standard (Specular setup)"
{
	Properties
	{
		[HideInInspector] _ColorSpace ("__colorSpace", Float) = 0.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "V_MM_UnityStandardCore.cginc"
	...
	CustomEditor "V_MM_StandardShaderGUI"
}
