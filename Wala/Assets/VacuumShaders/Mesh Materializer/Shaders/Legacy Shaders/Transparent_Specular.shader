...
Shader "VacuumShaders/Mesh Materializer/Legacy Shaders/Specular/Transparent"
{
	Properties 
	{
	...
	Fallback "VacuumShaders/Mesh Materializer/Legacy Shaders/Unlit/Transparent"
}
